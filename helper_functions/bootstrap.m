...
desired_start1 = 0;       %minutes
desired_start2 = 24;       %minutes
epoch_length = 300;         %seconds
...
xlabel('Frequency (Hz)');
ylabel('Power (dB)');
title(sprintf('Bootstrapped Power Spectrum with 95%% CI (%.2f - %.2f sec)', start_time1, end_time1));
grid on;
